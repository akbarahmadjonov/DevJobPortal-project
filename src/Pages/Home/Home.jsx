...
return <div className="home">
 ...
 <h1 className="home__hero-title">Find your dream<span className="home__hero-title-span">&nbsp;job</span>
full time, part time
</h1>
...
<BlueButton>Find me a job</BlueButton>
  ...
  <img className="home__hero-img1"  width={429} height={489}   src={womanImage} alt="dots" />
  </div>
  </div>
  ...
  <section className="home__why-section">
    ...
    <ul className="why-section__list">
      <li className="why-section__item">
        ...
        <p className="why-section__item-title">
        No discount on salaries
        </p>
        <p className="text why-section__item-text">On your monthly payment, we get no 
discount. We don’t charge you anything, 
all the money is yours.</p>
      </li>
      <li className="why-section__item">
        <div className="why-section__cubes">
        <span className="why-section__cube why-section__cube-blue"></span>
        ...
        <p className="text why-section__item-text">Would you say no to somebody who want
to help you land a job? That’s impossible.
      ...
      <li className="why-section__item">
        ...
        <p className="text why-section__item-text">Do you know the first thing you need
in your career? The people you do the 
same thing. Find them here</p>
      </li>
      <li className="why-section__item">
        <div className="why-section__cubes">
          <span className="why-section__cube"></span>
